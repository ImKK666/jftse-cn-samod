...
public final class PacketID {
    ...
    // 目前还不能正常工作
    public final static char S2CPlayerRenameEnd = 0x1021;
    public final static char C2SPlayerRenameRequest = 0x1022;
    public final static char S2CPlayerRenameAnswer = 0x1023;
