...
/* 临时取消恶意连接处理
                                            // Check the visitor, refuse the BAD GUYS
                                            ...
                                            if (!badGuys.isBadGuy(remoteIP)) {
                                                acceptOperation(socketChannel);
                                            } else {
                                                //log.debug(remoteIP+" 存在恶意访问行为，已暂时封禁");
...
*/
    ...
    public void start(String name) {
        ...
        t.start();
        //临时取消恶意连接处理
        //badGuys.runBadGuysReview(name+"|security task");
    }
